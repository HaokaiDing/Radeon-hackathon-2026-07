...
The recommended first visual is `submission/flightguard-challenge-arena-v1.mp4`: 140 frames, 1280×720, 20 fps, 7.0 seconds, 2,146,360 bytes, SHA-256 `aabdea74a53e07ba0b77b52cab68a5fd5f5ed03e68b81aa3647ef36d49dd5b65`. It is an exact Genesis replay of the summary-bound frozen pair. The primary full reviewer video is `submission/flightguard-challenge-arena-workflow-demo-v3.mp4`: 2,100 English-captioned frames, 1280×720, 10 fps, 210.0 seconds, no audio, 17,874,513 bytes, SHA-256 `d72057ff2a1bdf1796240a857f6451f545c070204ec6dcbe551f2dd039e00670`. It begins with the complete Challenge Arena clip and then presents only the submitted Challenge Arena, no-op/kill, controller-delta, reproduction, application, and Radeon-scaling evidence. `submission/flightguard-nominal-envelope-demo-v2.mp4` remains a historical reviewer artifact.
