...
[![FlightGuard one-minute evidence tour: paired simulation failure, recovery, hard-course visualization, Radeon scaling, and limits](submission/flightguard-final-narrative-v3-poster.png)](submission/flightguard-final-narrative-v3.mp4)

[`submission/flightguard-final-narrative-v3.mp4`](submission/flightguard-final-narrative-v3.mp4) is the primary judge entry: **60.9 seconds, 1280×720, 60 fps, simulation-only**. It moves from the paired Challenge Arena failure and recovery to the A2RL-derived 13-gate visualization, then Radeon/ROCm scaling and explicit limitations. The Challenge Arena results are the frozen formal evidence; the A2RL-derived course is labeled visual-only and metric-ineligible and does not change the formal 384/192 results. See the [provenance record](submission/evidence/flightguard-final-narrative-v3-provenance.json).
...
|---|---|---|
| `submission/evidence/flightguard-final-narrative-v3-provenance.json` | `ec08c8eedfdf67f9da6fc23d71ce7decb26dfce83a2e1ee00b4d0ff3d08534e8` | provenance and validation for the 60.9-second judge video |
...
- `submission/flightguard-final-narrative-v3.mp4`: primary 60.9-second, 60 fps judge evidence tour
- `submission/flightguard-final-narrative-v3-poster.png`: poster for the one-minute tour
